#!/usr/bin/env python3
"""Force the frozen Intl402 Temporal.PlainDate.prototype.equals surface."""
...
SURFACE = read_manifest("test262_temporal_plain_date_equals_intl_admission.txt") | read_manifest(
