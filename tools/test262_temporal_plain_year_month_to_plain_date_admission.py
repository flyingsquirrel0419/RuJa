"""Exact Test262 coverage for Temporal.PlainYearMonth.prototype.toPlainDate."""
...
TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES = frozenset(
    line
...
TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FEATURES = {
    path: _features(path) for path in TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES
}
TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_INCLUDES = {
    path: _includes(path) for path in TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES
}
TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FLAGS = {
    path: frozenset() for path in TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES
}
TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_NEGATIVE = {
    path: None for path in TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES
}

if len(TEMPORAL_PLAIN_YEAR_MONTH_TO_PLAIN_DATE_FILES) != 12:
    raise RuntimeError("PlainYearMonth.prototype.toPlainDate admission must contain 12 files")
