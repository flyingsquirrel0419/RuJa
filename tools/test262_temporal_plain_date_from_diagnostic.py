#!/usr/bin/env python3
"""Force the frozen Temporal.PlainDate.from surface through RuJa."""
...
SURFACE = read_manifest("test262_temporal_plain_date_from_admission.txt") | read_manifest(
    "test262_temporal_plain_date_from_blockers.txt"
)
