#!/usr/bin/env python3
"""Force the complete 100-file PlainDateTime.prototype.with result surface."""
...
SURFACE = TEMPORAL_PLAIN_DATE_TIME_WITH_COMPLETE_FILES
DIRECT = TEMPORAL_PLAIN_DATE_TIME_WITH_FILES
DIRECT_BLOCKERS = TEMPORAL_PLAIN_DATE_TIME_WITH_DIRECT_BLOCKERS
INTL_BLOCKERS = TEMPORAL_PLAIN_DATE_TIME_WITH_INTL_BLOCKERS
...
_EXPECTED_FAILURE_DIAGNOSTIC_DIGEST = (
    "f68eb1166f50565cd2f20e88f87d99771fb1679cc97fb6eee8c2f4fcf96ccdf1"
)
...
def verify_expected_results(arguments):
    ...
    if (
        ...
        raise RuntimeError(
            "complete PlainDateTime with diagnostic requires the exact frozen "
            "100-file surface"
        )
