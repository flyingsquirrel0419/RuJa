...
if len(TEMPORAL_DURATION_FROM_FILES) != 29:
    raise RuntimeError("Temporal.Duration.from admission must contain 29 files")
if len(TEMPORAL_DURATION_FROM_BLOCKERS) != 2:
    raise RuntimeError("Temporal.Duration.from blockers must contain 2 files")
