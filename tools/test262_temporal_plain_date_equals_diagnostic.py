#!/usr/bin/env python3
"""Force the frozen Temporal.PlainDate.prototype.equals surface through RuJa."""
...
SURFACE = read_manifest("test262_temporal_plain_date_equals_admission.txt") | read_manifest(
