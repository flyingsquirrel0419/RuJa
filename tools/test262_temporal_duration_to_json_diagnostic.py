#!/usr/bin/env python3
"""Force the frozen Temporal.Duration.prototype.toJSON surface through RuJa."""
...
def should_skip(meta, path=None):
    if path is not None and _relative(path) in TEMPORAL_DURATION_TO_JSON_FILES:
        return False
