...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 31.5% of all matrix files; 62.2% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28836257481 on `788ac63`.
