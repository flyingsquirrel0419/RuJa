...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 31.5% of all matrix files; 63.2% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28841412169 on `cc6c3bd`.
...
| Timeout | 13 |
| Skip | 24,321 |
| **Pass rate (of run)** | **63.2%** |
| **Pass rate (of total)** | **31.5%** |
