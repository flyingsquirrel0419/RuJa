...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 26.8% of all matrix files; 55.1% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
| Timeout | 13 |
| Skip | 24,542 |
| **Pass rate (of run)** | **55.1%** |
| **Pass rate (of total)** | **26.8%** |
