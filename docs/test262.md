...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 25.4% of all matrix files; 52.3% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
| Timeout | 11 |
| Skip | 24,542 |
| **Pass rate (of run)** | **52.3%** |
| **Pass rate (of total)** | **25.4%** |
