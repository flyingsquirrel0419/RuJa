...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 26.2% of all matrix files; 54.7% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
| Timeout | 13-15 |
| Skip | 25,290 |
| **Pass rate (of run)** | **54.7%** |
| **Pass rate (of total)** | **26.2%** |
