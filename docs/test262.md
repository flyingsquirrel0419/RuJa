...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 31.6% of all matrix files; 62.4% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28838779045 on `831b135`.
...
| Timeout | 0 |
| Skip | 23,573 |
| **Pass rate (of run)** | **62.4%** |
| **Pass rate (of total)** | **31.6%** |
