...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 32.1% of all matrix files; 64.5% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28860621487 on `8048811`.
