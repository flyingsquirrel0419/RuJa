...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 28.3% of all matrix files; 58.3% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28784946307 on `2a79fa3`.
...
| Timeout | 13 |
| Skip | 24,542 |
| **Pass rate (of run)** | **58.3%** |
| **Pass rate (of total)** | **28.3%** |
