...
|-------|-----------------|-------------|-----------------|
| **Full suite** | Entire test262 tree (excl. intl402/staging) — includes thousands of tests for features RuJa does not support | 32.0% of all matrix files; 64.2% of executed files in the latest confirmed full run | `test262-full` CI workflow job summary |
...
`test262-full` 28858209376 on `5759ab8`.
...
| Timeout | 13 |
| Skip | 24,321 |
| **Pass rate (of run)** | **64.4%** |
| **Pass rate (of total)** | **32.1%** |
