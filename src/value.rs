...
pub struct TemporalDurationFields {
    pub years: f64,
    pub months: f64,
    pub weeks: f64,
    pub days: f64,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct TemporalPlainMonthDayFields {
    pub reference_iso_year: i32,
    pub month: u8,
    pub day: u8,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct TemporalPlainTimeFields {
    pub hour: u8,
    pub minute: u8,
    pub second: u8,
    pub millisecond: u16,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct TemporalPlainYearMonthFields {
    pub year: i32,
    pub month: u8,
    pub reference_iso_day: u8,
}
...
pub struct AsyncFunctionContinuation {
    ...
    pub finally_stack: Vec<FinallyGuardState>,
...
pub struct LazyGeneratorData {
    ...
    pub finally_stack: Mutex<Vec<FinallyGuardState>>,
