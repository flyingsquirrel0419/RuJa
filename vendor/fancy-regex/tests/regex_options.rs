...
#[test]
fn ecmascript_capture_mode_does_not_change_default_delegation() {
    let regex = RegexBuilder::new(r"^(a|aa)+$")
        .build()
        .expect("default repeated captures should remain delegated");
